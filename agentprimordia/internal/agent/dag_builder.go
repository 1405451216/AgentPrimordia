...
func (n *NodeHandlerFunc) Stats() AgentStats {
	return AgentStats{}
}

func (n *NodeHandlerFunc) StreamRun(ctx context.Context, input Message) (<-chan StreamEvent, error) {
...
func (n *NodeHandlerFunc) Run(ctx context.Context, msg Message) (*Response, error) {
...
// NodeWithAgent 添加节点（使用已有的 Agent 实例）
...
// WithHooks 设置工作流钩子
func (b *DAGBuilder) WithHooks(hooks Hooks) *DAGBuilder {
	if b.err != nil {
		return b
	}
	b.workflow.SetHooks(hooks)
	return b
}
