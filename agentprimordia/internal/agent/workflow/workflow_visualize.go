// workflow_visualize.go — 工作流可视化（Mermaid / Graphviz DOT）
//   - ToMermaid / ToMermaidWithConfig / ToMermaidWithExecution
//   - ToDot / ToDotWithConfig / ToDotWithExecution
//   - VisualizeConfig / DefaultVisualizeConfig
//
// 本文件从父包 visualize.go 迁移而来，方法挂在 WorkflowExecution 上。
package workflow
