...
| 5 | 技能格式文档 | `agentprimordia/docs/guides/技能格式.md` | Skill YAML/JSON 格式规范 + 编写指南 |
...
| 5 | 互操作指南文档 | `agentprimordia/docs/guides/A2A互通.md` | 如何让第三方 Agent 调用 ap Agent + 反向 |
...
| 4 | 实时 API 文档 | `agentprimordia/docs/guides/实时通信.md` | 语音会话接入指南 + 适配器开发指南 |
...
| 7 | **文档同步** | 每版本完成需更新：CHANGELOG、`agentprimordia/docs/`、`docs/路线图.md` |
