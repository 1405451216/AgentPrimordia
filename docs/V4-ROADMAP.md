...
|------|------|-------------|-------------|-------------------|------------------|-----------|------|
| v3.3 | 长期自治 | 15/15 | 5/5 | 5/5 | 6/6 | `autonomous-task/` | ⬜ 待启动 |
| v3.4 | 技能进化 | 14/14 | 5/5 | 5/5 | 6/6 | `skill-evolution/` | ⬜ 待启动 |
| v3.5 | 协议互操作 | 10/10 | 5/5 | 5/5 | 6/6 | `a2a-interop/` | ⬜ 待启动 |
| v3.6 | 多模态实时 | 13/13 | 5/5 | 4/4 | 6/6 | `realtime-voice/` | ⬜ 待启动 |
