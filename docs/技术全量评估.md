...
**不足与闭环状态**：
- `CHANGELOG.md` 断档 — ✅ 第三轮已补写 v2.0.0/v3.0.0/v3.1.0 完整条目，`版本规范.md` 建立单一事实来源
...
| 4 | 版本管理脱节 | CHANGELOG 补写 v2.0.0/v3.0/v3.1 完整条目；版本规范.md 建立单一事实来源 | — |
...
| 7 | 性能瓶颈缓解指南 | 创建 `docs/advanced/scaling-guide.md` + `docs/advanced/向量库选型.md` | — |
...
| `docs/advanced/向量库选型.md` | 向量存储选型指南 |
| `docs/advanced/scaling-guide.md` | 性能扩展与瓶颈缓解 |
| `docs/advanced/市场协议.md` | Agent 市场分发协议设计 |
| `docs/advanced/集群验证.md` | 集群多节点验证方案 |
...
| `docs/版本规范.md` | +单一事实来源 + 发布纪律 + RegisterPProf 废弃 |
