...
> **覆盖范围**：完整版本路线 = 历史轨迹（v0.1.0 → v3.2.0，见 §二.六）+ 实证版本路线（v3.3 → v4.0，见 §三）+ 均衡混排弧线（v4.1 → v5.0，见 §三.五）+ 优化→大成弧线（v5.1 → v6.0，已全部 ✅ 核心完成并于 2026-08-21 发布 v6.0.0，详细进度表见 [`V6-ROADMAP.md`](V6-ROADMAP.md)）。
...
> 方向：均衡混排——奇数版本=能力深化，偶数版本=工程稳定，逐版本推进到 v5.0 平台里程碑。全部 10 版本已完成（进度与代码证据见 V5-ROADMAP.md 进度跟踪表）。
> 详细实施计划（含 v4.1 全量任务表）：[`V5-ROADMAP.md`](V5-ROADMAP.md)。
...
| v4.1 → v5.0 | 均衡混排弧线 | 真实化/规模化/平台化（✅ 已完成，见 V5-ROADMAP.md） |
...
5. 本弧线版本状态以 docs/V5-ROADMAP.md 进度跟踪表为准，每版本完成须在 ROADMAP.md 更新状态并附代码证据（文件:行号）
