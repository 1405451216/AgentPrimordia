...
>
> **最后更新**：2026 年 8 月 9 日
> **当前版本**：Go SDK v5.0.0（`pkg/agent.go`）/ TypeScript SDK v5.0.0（`sdk/typescript/package.json`）
> **覆盖范围**：完整版本路线 = 历史轨迹（v0.1.0 → v3.2.0，见 §二.六）+ 实证版本路线（v3.3 → v4.0，见 §三）+ 均衡混排弧线（v4.1 → v5.0，见 §三.五）。
