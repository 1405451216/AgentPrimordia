...
>
> **最后更新**：2026 年 8 月 3 日
> **当前版本**：Go SDK v3.2.0 / TypeScript SDK v3.2.0（v3.3–v3.6 能力已实现，详见 [`V4-ROADMAP.md`](V4-ROADMAP.md)）
>
> **v3.3–v3.6 状态**：长期自治 / 技能进化 / 协议互操作 / 多模态实时 四个版本的核心实现、跨组件集成、开发者体验、测试与验收 demo 均已完成（进度表见 `V4-ROADMAP.md` §七）。本文档保留 v2.x 历史里程碑；v3.3+ 的任务级清单以 `V4-ROADMAP.md` 为准。
